=====================================
MULTI-TENANCY ON ASP.NET MVC SAMPLE
=====================================

This project is an example of multi-tenancy on ASP.NET MVC 2.0 using Visual Studio 2010. 
This sample utilizes the following utilities:

- Visual Studio 2010
- ASP.NET MVC 2.0
- .NET 4.0
- IIS7
- StructureMap (lib folder)
- xUnit.NET (lib folder)
...
This sample is subject to the following license
...
in section 3, each contributor grants you a non-exclusive, worldwide, royalty-free license under its licensed 
